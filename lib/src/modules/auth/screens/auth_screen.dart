...
class _AuthScreenState extends State<AuthScreen> {
    ...
    try {
      ...
      if (_isSignUp) {
        await Provider.of<AuthProvider>(context, listen: false)
            .signUpWithWithEmailAndPassword(_authForm);
      } else {
        await Provider.of<AuthProvider>(context, listen: false)
            .signInWithEmailAndPassword(_authForm);
      }
  ...
  bool _isFormValid() {
    ...
    if (_isSignUp) {
      if (isFormValid && _authForm.isUserAgree == true) return true;
    } else {
